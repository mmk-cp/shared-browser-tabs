...
The Xvfb layout reserves twelve non-overlapping window slots. Individual viewports range from 280×200 to 1800×1300; larger clients are scaled proportionally. Closing a tab frees its slot. This is a shared browser-session application, not a security boundary between untrusted website origins: profile storage is shared by design.
